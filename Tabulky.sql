...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2019 at 05:59 PM
...
--
-- Table structure for table `ion_articles`
--

CREATE TABLE `ion_articles` (
...
--
-- Dumping data for table `ion_articles`
--

INSERT INTO `ion_articles` (`id`, `title`, `text`) VALUES
(1, 'A random article', 'From the looks of it, all you have done is create a link going to auth/delete_user and you most definitely do need to add something in the Controller!!\r\n\r\nWhen you say you\'ve \"created a page called delete_user.php\", is this a Controller you\'ve created, or a View?\r\n'),
(2, 'A random article', 'From the looks of it, all you have done is create a link going to auth/delete_user and you most definitely do need to add something in the Controller!!\r\n\r\nWhen you say you\'ve \"created a page called delete_user.php\", is this a Controller you\'ve created, or a View?\r\n'),
(3, 'A random article', 'From the looks of it, all you have done is create a link going to auth/delete_user and you most definitely do need to add something in the Controller!!\r\n\r\nWhen you say you\'ve \"created a page called delete_user.php\", is this a Controller you\'ve created, or a View?\r\n'),
(4, 'A random article', 'From the looks of it, all you have done is create a link going to auth/delete_user and you most definitely do need to add something in the Controller!!\r\n\r\nWhen you say you\'ve \"created a page called delete_user.php\", is this a Controller you\'ve created, or a View?\r\n'),
(5, 'A random article', 'From the looks of it, all you have done is create a link going to auth/delete_user and you most definitely do need to add something in the Controller!!\r\n\r\nWhen you say you\'ve \"created a page called delete_user.php\", is this a Controller you\'ve created, or a View?\r\n');
...
INSERT INTO `ion_login_attempts` (`id`, `ip_address`, `login`, `time`) VALUES
(1, '::1', 'admin@admin.com', 1546802994),
(2, '::1', 'admin@admin.com', 1546803003),
(3, '::1', 'admin@admin.com', 1546803025),
(4, '::1', 'admin@admin.cz', 1546803036),
(5, '::1', 'kagetaju@gmail.com', 1546888289),
(6, '::1', 'kagetaju@gmail.com', 1546888598),
(7, '::1', 'kagetaju@gmail.com', 1546888635),
(8, '::1', 'admin@admin.com', 1546888704);
...
INSERT INTO `ion_users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
...
(505, '::1', 'Random', '$2y$10$6etNUghpr5Yci4atmF4aM.Ar2OLxlqCtAOqGUNPVA79pWk0ezUTqG', 'random@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1546803476, 1546888920, 1, 'RandomR', NULL, NULL, NULL);
...
--
-- Indexes for table `ion_articles`
--
ALTER TABLE `ion_articles`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ion_articles`
--
ALTER TABLE `ion_articles`
...
--
-- Constraints for table `ion_users_groups`
--
ALTER TABLE `ion_users_groups`
